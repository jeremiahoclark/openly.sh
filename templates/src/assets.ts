...
// Open Air mark: ink tile, cream ring broken open at the north-east,
...
export function renderOgCardSvg(origin: string): string {
  ...
  <text x="306" y="252" fill="#222222" font-size="104" font-weight="700" letter-spacing="-2" font-family="-apple-system,BlinkMacSystemFont,'SF Pro Display','Segoe UI',sans-serif">${escapeSvg(BRAND)}</text>
  <rect x="310" y="282" width="150" height="10" rx="5" fill="#E8500F"/>
  <text x="306" y="372" fill="#6A6A6A" font-size="40" font-family="-apple-system,BlinkMacSystemFont,'SF Pro Text','Segoe UI',sans-serif">Own your links. See every click.</text>
  <text x="306" y="520" fill="#8C8C8C" font-size="26" font-family="-apple-system,BlinkMacSystemFont,'SF Pro Text','Segoe UI',sans-serif">${escapeSvg(host)}</text>
</svg>`;
}
